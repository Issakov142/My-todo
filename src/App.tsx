...
function App() {
    ...
    return (
        <div className="App">
            ...
            <Todolist addTask={addTask} tasks={filteredItems} title={'What to learn'} deleteTask={deleteTask} filterTask={filterTasks} changeTaskStatus={changeTaskStatus} filter={filter}/>
        </div>
    );
}
